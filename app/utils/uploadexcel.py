...
def upload_file():
    ...
    df = pd.read_excel(r"data\raw\disease_preventionlist.xlsx")

    # Replace NaN values with 'Unknown' or an empty string
    ...
    for index, row in df.iterrows():
        query = "INSERT INTO disease_details  (`disease_name`, `disease_cause`, `chemical_methods`, `natural_methods`, `diseases`) VALUES (%s, %s,%s, %s, %s)"
...
def home():
    return "Welcome to Agri-Innovative!"
